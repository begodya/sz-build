...
const packageTemp = `{
    ...
    "version": "0.1.0",
    "scripts": {
        "serve": "cross-env NODE_ENV=serve webpack-dev-server --config ./node_modules/sz-build/service/webpack/webpack.dev.js",
        "build": "cross-env NODE_ENV=build webpack --config ./node_modules/sz-build/service/webpack/webpack.prod.js "
    },
    "license": "ISC"
}
`;
...
const confList = [{ // 创建配置文件
    dest: `./${store.dirname}/szbuild.config.js`,
    temp: configTemp,
  },
